<?php
/**
 * Taxonomy archive template for Service Category.
 *
 * @package Carvice
 */
...
<main id="primary" class="carvice-main">
    <section class="carvice-archive-header">
        <div class="carvice-container">
            <h1 class="carvice-archive-header__title">
                <?php get_template_part( 'template-parts/category-icon', $term->slug ); ?>
    ...
    <section class="carvice-providers-section">
        <div class="carvice-container">
            ...
            <?php else : ?>
                <p class="carvice-no-content"><?php esc_html_e( 'No providers found in this category.', 'carvice' ); ?></p>
            <?php endif; ?>
        </div>
    </section>
</main>
