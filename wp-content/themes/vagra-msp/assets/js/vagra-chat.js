 ...
 * Vagra Chat Widget
 *
 * Vanilla JS chat UI for the Vagra AI chat component.
 * Shared across both MSP and Legal themes.
 *
 * @package Vagra
 */
...
(function () {
    ...
    var MAX_HISTORY = 50;
    var STORAGE_KEY = 'vagra_chat_history';
    ...
    var disclaimer = chat.dataset.disclaimer || '';
    ...
    function init() {
        ...
        // Show disclaimer as first message if present and no history
        if (disclaimer && history.length === 0) {
            appendMessage('assistant', disclaimer, true);
        }
    }
    ...
    function sendMessage(text) {
        ...
        xhr.send(JSON.stringify({
            message: text.trim(),
            history: history.slice(0, -1) // send history without the message we just added
        }));
    }
