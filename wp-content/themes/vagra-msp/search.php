...
<div class="vagra-page-header">
    <div class="vagra-container">
        <h1 class="vagra-page-header__title">
            ...
            printf( esc_html__( 'Search Results for: %s', 'vagra-msp' ), '<span>' . get_search_query() . '</span>' );
            ?>
        </h1>
    </div>
</div>
                ...
                <?php if ( have_posts() ) : ?>
                    ...
                    <div class="vagra-pagination">
                        ...
                        the_posts_pagination( array(
                            'mid_size'  => 2,
                            'prev_text' => esc_html__( '&laquo; Previous', 'vagra-msp' ),
                            'next_text' => esc_html__( 'Next &raquo;', 'vagra-msp' ),
                        ) );
                        ?>
                    </div>
                <?php else : ?>
