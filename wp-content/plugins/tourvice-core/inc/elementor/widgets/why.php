...
class Why extends TourVice_Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->add_responsive_control( 'section_padding', [
            ...
            'size_units' => [ 'px', 'em', '%' ],
            'selectors'  => [
                '{{WRAPPER}} .tourvice-why' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],
        ] );
        ...
        $this->add_responsive_control( 'content_align', [
            ...
            'selectors' => [
                '{{WRAPPER}} .tourvice-why' => 'text-align: {{VALUE}};',
            ],
        ] );
        ...
        $this->add_responsive_control( 'columns', [
            ...
            'selectors' => [
                '{{WRAPPER}} .tourvice-why__grid' => 'grid-template-columns: repeat({{VALUE}}, 1fr);',
            ],
        ] );
        ...
        $this->add_responsive_control( 'grid_gap', [
            ...
            'selectors'  => [
                '{{WRAPPER}} .tourvice-why__grid' => 'gap: {{SIZE}}{{UNIT}};',
            ],
        ] );
