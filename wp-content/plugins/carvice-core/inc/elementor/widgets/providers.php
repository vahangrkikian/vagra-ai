...
class Providers extends Carvice_Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->add_responsive_control( 'section_padding', [
            ...
            'size_units' => [ 'px', 'em', '%' ],
            'selectors'  => [ '{{WRAPPER}} .carvice-providers-section' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ],
        ] );
        ...
        $this->add_responsive_control( 'title_size', [
            ...
            'selectors'  => [ '{{WRAPPER}} .carvice-section-header__title' => 'font-size: {{SIZE}}{{UNIT}};' ],
        ] );
        ...
        $this->add_responsive_control( 'content_align', [
            ...
            'selectors' => [ '{{WRAPPER}} .carvice-providers-section' => 'text-align: {{VALUE}};' ],
        ] );
        ...
        $this->add_responsive_control( 'grid_columns', [
            ...
            'selectors' => [ '{{WRAPPER}} .carvice-providers-grid' => 'grid-template-columns: repeat({{VALUE}}, 1fr);' ],
        ] );
        ...
        $this->add_responsive_control( 'grid_gap', [
            ...
            'selectors'  => [ '{{WRAPPER}} .carvice-providers-grid' => 'gap: {{SIZE}}{{UNIT}};' ],
        ] );
